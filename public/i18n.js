  ...
  const messages = {
    en: {
      ...
      findatime: {
        ...
        mcpIntro: 'Add findatime to an assistant that supports remote Streamable HTTP MCP. The assistant can then use the scheduling tools below.',
        mcpFeatureEyebrow: 'AI ASSISTANT',
        mcpFeatureTitle: 'Schedule with your AI assistant',
        mcpFeatureDescription: 'Connect findatime to a remote MCP client to create meetings, check responses, and share your availability in a conversation.',
        mcpFeatureLink: 'How to connect',
        mcpEndpointLabel: 'Remote MCP address · Streamable HTTP',
        mcpCopy: 'Copy address',
        mcpCopied: 'Copied',
        mcpCopyFailed: 'Copy failed — select the address manually.',
        mcpAuth: 'Authentication: none required.',
        mcpStepsLabel: 'How to connect',
        mcpStepOne: "In your client's MCP settings, add a remote server using Streamable HTTP.",
        mcpStepTwo: 'Paste the address above and choose no authentication.',
        mcpStepThree: 'Once connected, ask your assistant to create or check a meeting. Include the date, time, and time zone.',
        mcpExamplesLabel: 'Try saying',
        mcpExampleCreate: '“Create a 60-minute project meeting in Asia/Shanghai next Saturday, with options at 14:00 and 16:00. Give me the share link.”',
        mcpExampleSubmit: '“Read this meeting link and its responses. I can attend the first option; submit my availability.”',
        mcpToolsLabel: 'Available tools',
        mcpCreate: 'Set a title, your name, a 30–480 minute duration in 30-minute steps, a time zone, and 1–10 candidate times. Get a share link and a private creator token.',
        mcpGet: 'Use a known meeting ID to read candidate times, votes, and participants. This does not list every meeting.',
        mcpSubmit: 'Read candidate time IDs, then submit your choices or mark yourself unavailable. No token is needed the first time; use your returned participantToken or creatorToken to update your response.',
        mcpSecurity: 'Share only the meeting link. creatorToken and participantToken can change your response: keep them in a trusted client. A name cannot recover a lost token.',
    ...
    'zh-CN': {
      ...
      findatime: {
        ...
        mcpIntro: '将 findatime 添加到支持远程 Streamable HTTP MCP 的助手中，即可使用下方的约时间工具。',
        mcpFeatureEyebrow: 'AI 助手',
        mcpFeatureTitle: '用 AI 助手轻松约时间',
        mcpFeatureDescription: '将 findatime 连接到支持远程 MCP 的助手，就能通过对话创建约会、查看回应，并提交自己的空闲时间。',
        mcpFeatureLink: '查看连接方法',
        mcpEndpointLabel: '远程 MCP 地址 · Streamable HTTP',
        mcpCopy: '复制地址',
        mcpCopied: '已复制',
        mcpCopyFailed: '复制失败，请手动选择地址。',
        mcpAuth: '认证方式：无需认证。',
        mcpStepsLabel: '连接步骤',
        mcpStepOne: '在客户端的 MCP 设置中，添加使用 Streamable HTTP 的远程服务器。',
        mcpStepTwo: '粘贴上方地址，认证方式选择“无”。',
        mcpStepThree: '连接后让助手创建或查看约会，并说明具体日期、时间和时区。',
        mcpExamplesLabel: '可以这样说',
        mcpExampleCreate: '“请用 Asia/Shanghai 时区创建一场 60 分钟的项目讨论，候选时间是下周六 14:00 和 16:00，然后给我分享链接。”',
        mcpExampleSubmit: '“读取这条约会链接及投票情况。我能参加第一个候选时间，请帮我提交。”',
        mcpToolsLabel: '可用工具',
        mcpCreate: '填写标题、姓名、30–480 分钟时长（以 30 分钟递增）、时区和 1–10 个候选时间，获得分享链接及私密创建者令牌。',
        mcpGet: '用已知约会的 ID 查看候选时间、票数和参与者；此工具不会列出所有约会。',
        mcpSubmit: '先读取候选时间 ID，再提交自己的选择或标记无法参加。首次提交无需令牌；更新回应时使用返回的 participantToken 或创建时的 creatorToken。',
        mcpSecurity: '只分享约会链接。creatorToken 和 participantToken 是修改凭据，请保存在可信客户端；同名无法找回丢失的令牌。',
        noLogin: '无需登录 ·',
